"""Tests for md2pdf mermaid rendering and self-healing.

Covers pure helper functions, mocked network/AI calls, and SVG manipulation.
"""
...
class TestRenderMermaidToSvg:
    def test_successful_render_returns_svg(self) -> None:
        ...
        with patch("openpaw.builtins.tools.md2pdf.mermaid.httpx.get", return_value=mock_response):
    ...
    def test_http_error_returns_error_message(self) -> None:
        ...
        with patch("openpaw.builtins.tools.md2pdf.mermaid.httpx.get", side_effect=http_error):
    ...
    def test_network_error_returns_error_message(self) -> None:
        with patch(
            "openpaw.builtins.tools.md2pdf.mermaid.httpx.get",
...
class TestTrySelfHeal:
    ...
    def test_successful_heal_updates_block(self) -> None:
        ...
        with patch("langchain.chat_models.init_chat_model", return_value=mock_llm), \
             patch("openpaw.builtins.tools.md2pdf.mermaid._build_repair_graph", return_value=mock_graph):
...
class TestRenderAllBlocks:
    ...
    def test_successful_render_populates_svg(self) -> None:
        ...
        with patch(
            "openpaw.builtins.tools.md2pdf.mermaid._render_mermaid_to_svg",
    ...
    def test_self_heal_true_triggers_heal_on_failure(self) -> None:
        ...
        ), patch("openpaw.builtins.tools.md2pdf.mermaid._try_self_heal") as mock_heal:
            _render_all_blocks(
    ...
    def test_multiple_blocks_all_rendered(self) -> None:
        ...
        with patch("openpaw.builtins.tools.md2pdf.mermaid._render_mermaid_to_svg", side_effect=fake_render):
            _render_all_blocks(
