...
- **Harness type renamed: `harness.type: planner` → `ultra`** (pre-release rename, tiers: react/balanced/ultra). All config values, identifiers, and telemetry now use `ultra`; no compatibility alias since 0.5.0 never shipped.
